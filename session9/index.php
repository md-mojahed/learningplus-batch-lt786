...
<div class="container-fluid d-none">
 ...
 <div class="row head w-100" style="position:fixed;top:0;z-index:2;">
     <div class="col-2" style="font-size:25px;"><a href="../login" class="h-100 text-center text-warning font-weight-bold">&#8592;</a></div>
...
<div class="w-100 modal p-2" style="background:rgba(0,0,0,0.3);"
  id="show-story">
   ...
   <div class="bg-light w-100 rounded p-2 text-center" style="margin:auto;height:40vw">
       ...
       <div class="form-control text-left story-div" style="overflow-y:scroll;height:38vh">
